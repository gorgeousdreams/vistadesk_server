...
*/
    public static function sigJsonToImage ($json, $options = array()) {
        ...
        foreach ($json as $v) 
        Signature::drawThickLine($img, $v->lx * $options['drawMultiplier'], $v->ly * $options['drawMultiplier'], $v->mx * $options['drawMultiplier'], $v->my * $options['drawMultiplier'], $pen, $options['penWidth'] * ($options['drawMultiplier'] / 2));
